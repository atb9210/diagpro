    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(empty($carrello))
            ...
            <div class="text-center py-12">
                ...
                <a href="{{ route('shop.index', $shop->slug) }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md btn-shop-primary hover:opacity-90 transition-opacity">
            ...
            <form action="{{ route('shop.checkout.processa', $shop->slug) }}" method="POST" id="checkout-form">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="mt-8">
                            <button type="submit" 
                                    class="w-full flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-md btn-shop-primary hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                    id="submit-btn">
                                <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
